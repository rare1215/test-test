  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(@NonNull final SupportSQLiteDatabase db) {
        db.execSQL("CREATE TABLE IF NOT EXISTS `Diary` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `content` TEXT)");
        db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '10a6fb0016d8adc5f6ee223c087abac6')");
      }
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        final HashMap<String, TableInfo.Column> _columnsDiary = new HashMap<String, TableInfo.Column>(2);
        _columnsDiary.put("id", new TableInfo.Column("id", "INTEGER", true, 1, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsDiary.put("content", new TableInfo.Column("content", "TEXT", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        if (!_infoDiary.equals(_existingDiary)) {
          return new RoomOpenHelper.ValidationResult(false, "Diary(com.example.diaryapp.Diary).\n"
                  + " Expected:\n" + _infoDiary + "\n"
                  + " Found:\n" + _existingDiary);
        }
        return new RoomOpenHelper.ValidationResult(true, null);
      }
    }, "10a6fb0016d8adc5f6ee223c087abac6", "6ad95119fa76acd0a503a32e1369f271");
